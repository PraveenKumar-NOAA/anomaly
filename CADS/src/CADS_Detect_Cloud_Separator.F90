...
INTEGER(KIND=4), INTENT(INOUT) :: K__Cloud_Flag(:) ! Cloud flags
INTEGER(KIND=4), INTENT(OUT)   :: K__Cloud_Level   ! Index of highest cloudy
                                                   ! channel
INTEGER(KIND=4), INTENT(OUT)   :: K__Clear_Level   ! Index of lowest clear
                                                   ! channel
INTEGER(KIND=4), INTENT(IN)    :: K__Scen_Index    ! Choice of scenario
INTEGER(KIND=4), INTENT(IN)    :: K__Start_Channel ! Choice of scenario
REAL(KIND=8), INTENT(IN)       :: P__DBT(:)        ! Input ranked dBT signal


! Local variables
REAL(KIND=8), ALLOCATABLE :: Z__DBT_w_Buffer(:) ! Smoothed-ranked DBT
INTEGER(KIND=4) :: I__Buffer                    ! No. of buffer channels
INTEGER(KIND=4) :: JCH,I
