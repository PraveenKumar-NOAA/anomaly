...
USE CADS_Module, ONLY : S__CADS_Setup_Trace_Gas
...
INTEGER(KIND=4),INTENT(OUT) :: K__Trace_Gas_Flag(:)

!* 0.2 local variables
INTEGER(KIND=4)              :: J, I_K, ICHAN
INTEGER(KIND=4),ALLOCATABLE  :: I__Sup_Count(:,:)
REAL(KIND=8),ALLOCATABLE     :: Z__Sup_Meanobs(:,:)
REAL(KIND=8),ALLOCATABLE     :: Z__Sup_MeanDep(:,:)
LOGICAL                      :: L__Tracegas

INTEGER(KIND=4)          :: I__Num_Trace_Gas_Checks    ! Number of of trace
                                                       ! gases
INTEGER(KIND=4), POINTER :: I__Num_Tracer_Channels(:)  ! Number of tracer
                                                       ! channels
INTEGER(KIND=4), POINTER :: I__Tracer_Channels(:,:)    ! Tracer channel lists
INTEGER(KIND=4), POINTER :: I__Num_Control_Channels(:) ! Number of control
                                                       ! channels
INTEGER(KIND=4), POINTER :: I__Control_Channels(:,:)   ! Control channel lists
INTEGER(KIND=4), POINTER :: I__Num_Flagged_Channels(:) ! Number of affected
                                                       ! channels
INTEGER(KIND=4), POINTER :: I__Flagged_Channels(:,:)   ! Affected channel lists
REAL(KIND=8), POINTER    :: Z__D_Obs_Threshold(:)      ! Threshold for
                                                       ! observation difference
REAL(KIND=8), POINTER    :: Z__D_Dep_Threshold(:)      ! Threshold for FG
