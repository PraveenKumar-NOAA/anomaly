...
INTEGER(KIND=4), INTENT(IN)    :: KV      ! length of V
INTEGER(KIND=4), INTENT(IN)    :: KW      ! length of averaging window
REAL(KIND=8),    INTENT(IN)    :: PV(:)   ! original array
REAL(KIND=8),    INTENT(INOUT) :: PVA(:)  ! averaged array

!* 0.2 local variables
INTEGER(KIND=4) :: INJ,J,I
