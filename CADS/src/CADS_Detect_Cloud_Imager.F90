...
INTEGER(KIND=4), INTENT(IN)  :: K__Nclust         ! No. of clusters
INTEGER(KIND=4), INTENT(OUT) :: K__Cloud_Flag     ! Output cloud flag
REAL(KIND=8),    INTENT(IN)  :: P__Cl_Fraction(:) ! Cluster fractions
REAL(KIND=8),    INTENT(IN)  :: P__Cl_Mean(:,:)   ! Cluster-mean BTs
REAL(KIND=8),    INTENT(IN)  :: P__Ov_Stddev(:)   ! Overall BT st.devs.
REAL(KIND=8),    INTENT(IN)  :: P__FG_BT(:)       ! First guess BT

!* Local variables - Setup of the imager cloud detection
INTEGER(KIND=4)          :: I__Num_Imager_Chans       ! No. of used channels
INTEGER(KIND=4), POINTER :: I__Imager_Chans(:)        ! List of used channels
REAL(KIND=8), POINTER    :: Z__Stddev_Threshold(:)    ! Homogeneity thresholds
REAL(KIND=8)             :: Z__Coverage_Threshold     ! Coverage threshold
REAL(KIND=8)             :: Z__FG_Departure_Threshold ! FG departure threshold

!* Additional local variables
INTEGER(KIND=4) :: I, J, IK, I_Temp_Flag, ICOUNT
INTEGER(KIND=4) :: I__Chan_Index(K__Nchans)
REAL(KIND=8) :: Z__Wsqdev, Z__Sqdev(K__Nclust), Z__Intercluster
